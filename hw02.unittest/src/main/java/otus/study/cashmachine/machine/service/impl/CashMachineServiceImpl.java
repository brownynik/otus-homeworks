...
public class CashMachineServiceImpl implements CashMachineService {
    ...
    public List<Integer> getMoney(CashMachine machine, String cardNum, String pin, BigDecimal amount) {
        try {
            ...
            //System.out.println( "machine.getMoneyBox().getNote5000() = " + machine.getMoneyBox().getNote5000());
            //System.out.println( "moneyBoxService.getNote5000() = " + machine.getMoneyBox().getNote5000());
